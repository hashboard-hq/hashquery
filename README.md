...
See [hashquery.dev](https://hashquery.dev) for a live demo.

Hashquery expressions are defined in Python, compiled into SQL, and run directly against your data warehouse. You can do simple pulls of metrics and features and also build up complex multi-layered data queries. It support features like funnel and sequence analysis that are hard to write by hand in standard SQL. It natively integrates with upstream semantic layers and can be used together with [Hashboard](https://hashboard.com) as a headless BI interface.
